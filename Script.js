...
const taskLists = document.getElementById('list');
const AddTaskInput = document.getElementById('add');
const CounterTasks = document.getElementById('tasks-counter');
const Buttons = document.getElementById('btn');
const Allcompleted = document.getElementById('complete-all');
...
function addTaskToDOM(task){
    ...
    li.innerHTML = `
        ...
        <img src="12.png" class="delete" data-id="${task.id}" />
    `;
    taskLists.append(li);
}
...
function initializeApp(){
    ...
    Buttons.addEventListener('mousedown', handleInputKeypress); // Change event listener to 'mousedown'
